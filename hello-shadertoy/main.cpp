...
class HelloShadertoyApplication {
public:
    void run() {
        initWindow();
        initVulkan();
...
private:
    ...
    void createGraphicsPipeline() {
        auto vertShaderCode = readFile("shader/main_vert.spv");
        auto fragShaderCode = readFile("shader/fireball_frag.spv");
