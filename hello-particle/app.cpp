...
void VulkanParticleApp::vk_cleanup() {
    ...
    if (enableValidationLayers) {
        vk_destroy_debug_utils_messenger_ext(vk_instance, debugMessenger, nullptr);
    }
...
void VulkanParticleApp::vk_setup_debug_messenger() {
    ...
    if (vk_create_debug_utils_messenger_ext(vk_instance, &createInfo, nullptr, &debugMessenger) != VK_SUCCESS) {
...
void VulkanParticleApp::vk_create_imageviews() {
...
void VulkanParticleApp::vk_create_buffer(VkDeviceSize size, VkBufferUsageFlags usage, VkMemoryPropertyFlags properties, VkBuffer& buffer, VkDeviceMemory& bufferMemory) {
...
void VulkanParticleApp::vk_copy_buffer(VkBuffer srcBuffer, VkBuffer dstBuffer, VkDeviceSize size) {
...
uint32_t VulkanParticleApp::vk_find_memory_type(uint32_t typeFilter, VkMemoryPropertyFlags properties) {
...
std::vector<char> VulkanParticleApp::readFile(const std::string& filename) {
